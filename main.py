...
material_list = ["Base", "Iron", "Steel", "Balck", "Mithril", "Adamant", "Rune", "Dragon"]
...
cape_skills_resp = OptionMenu(fr_skill_boosts_cooking, var_cape_skills, *cape_skill_cook_list)
...
var_chef_hat = IntVar()
chef_hat_resp = Checkbutton(fr_skill_boosts_cooking,variable=var_chef_hat, onvalue=1, offvalue=0, command=chef_hat)
...
cooking_apron_resp = Checkbutton(fr_skill_boosts_cooking,variable=var_cooking_apron, onvalue=1, offvalue=0, command=cooking_apron)
cooking_apron_resp.grid(column=1, row=3, sticky=tk.E, padx=5, pady=5)

ancient_ring_of_skills_text = Label(fr_skill_boosts_cooking, text='Ancient Ring of Skills')
ancient_ring_of_skills_text.grid(column=0, row=4, sticky=tk.W, padx=5, pady=5)
var_ancient_ring_of_skills = IntVar()
ancient_ring_of_skills_resp = Checkbutton(fr_skill_boosts_cooking,variable=var_ancient_ring_of_skills, onvalue=1, offvalue=0, command=ancient_ring_of_skills)
...
chef_spoon_resp = Checkbutton(fr_skill_boosts_cooking,variable=var_chef_spoon, onvalue=1, offvalue=0, command=chef_spoon)
...
burning_coals_resp = Checkbutton(fr_skill_boosts_cooking,variable=var_burning_coals, onvalue=1, offvalue=0, command=burning_coals)
...
sweltering_pools_resp = Checkbutton(fr_skill_boosts_cooking,variable=var_sweltering_pools, onvalue=1, offvalue=0, command=sweltering_pools)
...
art_of_control_cook_resp = Checkbutton(fr_skill_boosts_cooking,variable=var_art_of_control_cook, onvalue=1, offvalue=0, command=art_of_control_cook)
...
cooking_gloves_resp = Checkbutton(fr_skill_boosts_cooking,variable=var_cooking_gloves, onvalue=1, offvalue=0, command=cooking_gloves)
...
summoning_boosts_cook_resp = OptionMenu(fr_skill_boosts_cooking, var_summoning_boosts_cook, *summoning_boosts_list)
...
potion_mining_list = ['None', 'Perfect Swing Potion I', 'Perfect Swing Potion II', 'Perfect Swing Potion III', 'Perfect Swing Potion IV']
summoning_boosts_mining_list = ['None', 'Mone', 'Mone + Crow', 'Mone + Monkey', 'Mone + Bear']
ore_list = ['Copper Ore', 'Tin Ore', 'Rune Essence', 'Iron Ore', 'Silver Ore', 'Coal Ore', 'Gold Ore', 'Mithril Ore', 'Adamantite Ore', 'Runite Ore', 'Dragonite Ore']
...
def summoning_mining():
    ...
    if summoning_select == "None":
        ...
        return class_summoning
    if summoning_select == "Mone + Monkey" and ore_select == ("Silver Ore" or "Gold Ore"):
...
potion_mining_resp = OptionMenu(fr_skill_boosts_mining, var_potion_mining, *potion_mining_list)
...
summoning_boosts_mining_resp = OptionMenu(fr_skill_boosts_mining, var_summoning_boosts_mining, *summoning_boosts_mining_list)
...
mastery_pool_mining_resp = OptionMenu(fr_skill_boosts_mining, var_mastery_pool_mining, *mastery_pool_mining_list)
...
miner_helmet_resp = Checkbutton(fr_skill_boosts_mining,variable=var_miner_helmet, onvalue=1, offvalue=0, command=miner_helmet)
...
ancient_ring_mining_resp = Checkbutton(fr_skill_boosts_mining,variable=var_ancient_ring_mining, onvalue=1, offvalue=0, command=ancient_ring_mining)
...
pipe_balance_mining_resp = Checkbutton(fr_skill_boosts_mining,variable=var_pipe_balance_mining, onvalue=1, offvalue=0, command=pipe_balance_mining)
...
rock_climb_mining_resp = Checkbutton(fr_skill_boosts_mining,variable=var_rock_climb_mining, onvalue=1, offvalue=0, command=rock_climb_mining)
...
ice_jump_mining_resp = Checkbutton(fr_skill_boosts_mining,variable=var_ice_jump_mining, onvalue=1, offvalue=0, command=ice_jump_mining)
...
cool_rock_mining_resp = Checkbutton(fr_skill_boosts_mining,variable=var_cool_rock_mining, onvalue=1, offvalue=0, command=cool_rock_mining)
...
master_of_nature_mining_resp = Checkbutton(fr_skill_boosts_mining,variable=var_master_of_nature_mining, onvalue=1, offvalue=0, command=master_of_nature_mining)
...
mining_gloves_resp = Checkbutton(fr_skill_boosts_mining,variable=var_mining_gloves, onvalue=1, offvalue=0, command=mining_gloves)
...
# functions mining
def rock_hp():
    rock_hp_mining = 5 + var_mastery_lvl_mining.get() + summoning_mining().maxhp_summoning() + mastery_pool_mining().rock_pool() + pipe_balance_mining() + ice_jump_mining() + cool_rock_mining()
...
def time_cicle():
    ...
    time_cicle = (rock_hp() * (3 * (items.pickaxe[pickaxe_select]['mine time'] - master_of_nature_mining()))) + items.ores[ore_select]['respawn']
    return time_cicle
...
def ore_hr_mining():
    pickaxe_select = var_pickaxe_mining.get()
    ore_hr = ((rock_hp()/time_cicle())*3600) * items.pickaxe[pickaxe_select]['chance'] * mining_gloves() * summoning_mining().chance_summoning() * rock_climb_mining()
    return ore_hr
